...
export default Yup.object().shape({
    email: Yup.string().email('E-mail inválido').required('Por favor, informe o e-mail'),
    celular: Yup.string().required('Por favor, informe o celular').max(13, 'Celular inválido'),
