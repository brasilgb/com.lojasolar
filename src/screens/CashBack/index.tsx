      ...
      <AppLayout classname="bg-solar-gray-dark">
        ...
        <View className='flex-1 px-4' style={{ zIndex: 1 }}>
          <View className="flex-1 items-center justify-start bg-solar-gray-dark">
            ...
            <View className='flex-row items-center justify-between gap-2 px-2 py-4 w-full'>
              <View className='flex-1 flex-row items-center justify-start p-1 rounded-md bg-solar-blue-light'>
                <Ionicons name='document-text-outline' size={24} color='white' />
                <Text className='text-white ml-2'>Disponível</Text>
              </View>
              <View className='flex-1 flex-row items-center justify-start p-1 rounded-md bg-solar-orange-middle/80'>
                <Ionicons name='document-outline' size={24} color='#4b5563' />
                <Text className='text-gray-600 ml-2'>Utilizado</Text>
              </View>
            </View>
          ...
          <TouchableOpacity
            className={`flex items-center justify-center my-4 border-2 border-white
        ...
        >
          <View className='flex-1'>
            <ListItemsModal modalData={itemsModal} />
          </View>
          <View className='flex-row items-center justify-center mx-4 py-2 border-t border-gray-700/10'>
            <TouchableOpacity onPress={onClose}
            >
              <FontAwesome name="angle-double-down" size={40} color="#9b9b9b" />
            </TouchableOpacity>
          </View>
        </Modalize>
      </AppLayout>
