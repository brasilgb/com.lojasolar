                ...
                <View className="py-2 w-full flex-row items-center justify-between">
                    <View className="flex-col">
                        ...
                        <View className="w-full m-2">
                            <Text
                                allowFontScaling={false}
                                className="text-xl font-Poppins_400Regular"
                            >
                                {item.produto}
                            </Text>
                        </View>
                ...
                <View className="flex-col items-center justify-center">
                    ...
                    {protocols.length === 0 && (
                        <>
                            ...
                            <Text
                                allowFontScaling={false}
                                className="text-xl text-solar-blue-dark font-PoppinsMedium mb-4 pt-8 text-center"
                            >
                            ...
                            <Text
                                allowFontScaling={false}
                                className="text-sm text-solar-blue-dark font-PoppinsMedium mb-4 pt-8 text-center"
                            >
