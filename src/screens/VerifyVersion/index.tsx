                ...
                <View className="flex-1 flex-col items-center justify-between px-12 pt-4 mb-10">
                    <View className="mb-10">
                        <Text
                            ...
                            className="text-3xl text-solar-blue-dark py-8 text-center"
                        >
                    ...
                    <View className="w-full flex ">
                        <TouchableOpacity
                            ...
                            className={`flex items-center justify-center w-full bg-solar-orange-middle ${
                                Platform.OS == 'ios'
                        ...
                        >
                            <Text
                                allowFontScaling={false}
                                className="text-sm font-PoppinsMedium text-solar-gray-500 underline"
                            >
