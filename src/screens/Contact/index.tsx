        ...
        <AppLayout>
            <View className="flex-grow items-center justify-start bg-solar-gray-dark">
                <View className="py-4 flex items-center justify-center ">
                    ...
                    <Text
                        allowFontScaling={false}
                        className="text-base text-solar-blue-dark font-PoppinsRegular my-4"
                    >
                ...
                <Text
                    allowFontScaling={false}
                    className="text-xl font-PoppinsBold text-solar-blue-dark pt-5"
                >
                    51-3638-5000
                </Text>
                <Text
                    allowFontScaling={false}
                    className="text-sm font-PoppinsMedium text-solar-blue-dark py-5"
                >
                    sac@lojasolar.com.br
                </Text>
                <Text
                    allowFontScaling={false}
                    className="text-sm font-PoppinsRegular text-solar-blue-dark"
                >
                ...
                <Text
                    allowFontScaling={false}
                    className="text-base font-PoppinsMedium text-solar-blue-dark pt-4 text-center"
                >
